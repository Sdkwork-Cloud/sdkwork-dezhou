...
```bash
npm install @sdkwork-internal/dezhou-app-sdk-generated
# or
yarn add @sdkwork-internal/dezhou-app-sdk-generated
# or
pnpm add @sdkwork-internal/dezhou-app-sdk-generated
```

## Quick Start

```typescript
import { SdkworkDezhouAppClient } from '@sdkwork-internal/dezhou-app-sdk-generated';

const client = new SdkworkDezhouAppClient({
  baseUrl: '/app/v3/api',
  timeout: 30000,
});
